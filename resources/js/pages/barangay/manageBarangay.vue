...
<template>
    <div class="w-full flex flex-col bg-white">
        ...
        <!-- Page Header -->
        <div class="w-full px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
            <div>
        ...
        <div class="w-full flex flex-col divide-y divide-gray-100">
            ...
            <div class="w-full flex">
                <div class="w-56 shrink-0 border-r border-gray-100 px-6 py-5 bg-white">
                ...
                <div class="flex-1 px-6 py-5 bg-white">
                    <div class="w-full grid grid-cols-3 gap-5 text-xs">
            ...
            <div class="w-full flex">
                ...
                <div class="flex-1 px-6 py-5 bg-white">
                    <div class="w-full grid grid-cols-2 gap-5 text-xs">
                        <div class="flex flex-col gap-1.5">
                ...
                <div class="flex-1 px-6 py-5 bg-white">
                    ...
                    <div class="flex flex-col divide-y divide-gray-50">
                        <div v-for="(pp, index) in form.priority_programs" :key="index"
                            ...
                            <!-- Program: dropdown if new, name if existing -->
                            <div class="col-span-5 pl-3">
                                <template v-if="pp.id === null">
                                    <select v-model="pp.program_id"
                                        class="w-full border border-gray-200 bg-gray-50 outline-none px-3 py-2 text-gray-700 focus:bg-white focus:border-gray-400 transition-all">
                                        <option :value="null">Select Program</option>
                                        <option v-for="prog in props.programs" :key="prog.id" :value="prog.id">
                                            {{ prog.name }}
                                        </option>
                                    </select>
                                </template>
            ...
            <div class="w-full flex">
                ...
                <div class="flex-1 px-6 py-5 bg-white">
                    ...
                    <div class="grid grid-cols-12 text-[10px] font-semibold uppercase tracking-widest text-gray-400 border-b border-gray-100 pb-2 mb-2">
                        ...
                        <!-- <span class="col-span- text-right">Action</span> -->
                    </div>
        ...
        <!-- Footer Actions -->
        <div class="w-full px-6 py-4 border-t border-gray-200 bg-gray-50 flex justify-end items-center gap-3">
