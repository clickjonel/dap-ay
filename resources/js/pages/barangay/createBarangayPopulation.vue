...
const submit = () => {
    form.post('/barangay/population', {
        preserveScroll: true,
        onSuccess: () => {
            toast.add({
                severity: 'success',
                summary:  'Population Saved',
                detail:   'Population details have been saved successfully.',
                life:     2000,
            })
...
<template>
    <div class="h-full flex flex-col gap-5 min-h-0">
        ...
        <div class="flex items-center gap-4 shrink-0">
            ...
            <div>
                <h1 class="text-lg font-bold text-slate-800 leading-none">Set Population</h1>
