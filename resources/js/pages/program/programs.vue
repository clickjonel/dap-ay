            ...
            <table class="w-full text-left">
                <thead class="bg-slate-100 border-b border-slate-100 sticky top-0">
                    <tr>
                        ...
                        <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-wider text-slate-400 text-right"  v-if="user.access_levels?.access_level === 1">Actions</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-50">
                    ...
                    >
                        ...
                        <td class="px-5 py-3.5"  v-if="user.access_levels?.access_level === 1">
