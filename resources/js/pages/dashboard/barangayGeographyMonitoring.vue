                        ...
                        <template v-for="municipality in filteredMunicipalities" :key="municipality.id">
                            ...
                            >
                                ...
                                <td class="px-4 py-2.5 pl-8">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-1 h-1 rounded-full bg-slate-300 shrink-0"/>
                                        <span class="text-slate-600 text-[11px]">{{ barangay.geography?.longitude }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-2.5 pl-8">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-1 h-1 rounded-full bg-slate-300 shrink-0"/>
                                        <span class="text-slate-600 text-[11px]">{{ barangay.geography?.latitude }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-2.5 pl-8">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-1 h-1 rounded-full bg-slate-300 shrink-0"/>
                                        <span class="text-slate-600 text-[11px]">{{ barangay.geography?.is_gida ? 'Yes' : 'No' }}</span>
                                    </div>
                                </td>
