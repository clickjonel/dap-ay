                ...
                <table class="w-full text-xs border-collapse">
                    ...
                    <tbody>
                        ...
                        <template v-for="municipality in filteredMunicipalities" :key="municipality.id">
                            ...
                            <tr>
                                <td colspan="3" class="px-4 py-2 bg-slate-50 border-y border-slate-100">
                            ...
                            >
                                ...
                                <td class="px-4 py-2.5 pl-8">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-1 h-1 rounded-full bg-slate-300 shrink-0"/>
                                        <span class="text-slate-600 text-[11px]">{{ barangay.pk_profile?.pk_site ? 'Yes' : 'No' }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-2.5 pl-8">
                                    <div class="flex items-center gap-1.5">
                                        <span class="w-1 h-1 rounded-full bg-slate-300 shrink-0"/>
                                        <span class="text-slate-600 text-[11px]">{{ barangay.pk_profile?.pk_status }}</span>
                                    </div>
                                </td>
