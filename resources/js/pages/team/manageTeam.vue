<script setup>
    ...
    onMounted(()=>{
        ...
        console.log(props.team.barangays)
    })
            ...
            <div class="w-full flex flex-col justify-start items-start gap-4 text-xs py-2">
                <div v-for="(member,index) in team.members" class="w-full grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-3 flex flex-col gap-1.5">
                        ...
                        <input v-model="member.name" type="text" class="uppercase w-full border border-gray-400 bg-gray-50 outline-none px-3 py-2 text-gray-700 focus:bg-white focus:border-gray-400 transition-all placeholder:text-gray-400">
                    </div>
                    ...
                    <div class="col-span-2 flex flex-col gap-1.5">
                        ...
                        <select v-model="member.pk_oriented" class="w-full border border-gray-400 bg-gray-50 outline-none px-3 py-2 text-gray-700 focus:bg-white focus:border-gray-400 transition-all">
                            <option :value="null">Select</option>
