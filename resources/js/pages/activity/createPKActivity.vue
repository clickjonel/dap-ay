<script setup>
    ...
    const submitActivity = () => {
        ...
        router.post('/pk-activities', payload, {
            preserveScroll: true,
            onSuccess: () => {
            ...
            <Panel header="Participant Programs" toggleable class="w-full">
                <div class="w-full flex flex-col justify-start items-start gap-6 p-4">
                    ...
                    />
                        ...
                        <p v-if="pkActivityForm.errors.program_ids" class="text-[11px] text-red-500">{{ pkActivityForm.errors.program_ids }}</p>
                    </FloatLabel>
                </div>
            </Panel>
            ...
            <Panel header="Participant Barangays" toggleable class="w-full">
                <div class="w-full flex flex-col justify-start items-start gap-6 p-4">
                    <FloatLabel variant="on" class="w-full">
                        ...
                        <p v-if="pkActivityForm.errors.barangay_ids" class="text-[11px] text-red-500">{{ pkActivityForm.errors.barangay_ids }}</p>
                    </FloatLabel>
                </div>
            </Panel>
            ...
            <Panel header="Participant HRH" toggleable class="w-full">
                <div class="w-full flex flex-col justify-start items-start gap-6 p-4">
                    <FloatLabel variant="on" class="w-full">
                        ...
                        <p v-if="pkActivityForm.errors.hrh_ids" class="text-[11px] text-red-500">{{ pkActivityForm.errors.hrh_ids }}</p>
                    </FloatLabel>
                </div>
            </Panel>

            <Button @click="submitActivity" label="Save Activity" />
        </form>
