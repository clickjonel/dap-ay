...
const navLinks = [
    {
        ...
        children: [
            ...
            { label: 'Barangay Priority Programs Dashboard',  href: '/dashboard/barangay-monitoring/priority-programs', icon: 'hugeicons:shield-user',   accessLevels: [1,4,2,3] },
            { label: 'Barangay PK Profile Dashboard',  href: '/dashboard/barangay-monitoring/organizational-indicators', icon: 'hugeicons:shield-user',   accessLevels: [1,4,2,3] },
            { label: 'Primary Health Care Indicators',  href: '/dashboard/barangay-monitoring/primary-health-care', icon: 'hugeicons:shield-user',   accessLevels: [1,4,2,3] },
            ...
            { label: 'Barangay Geography Dashboard',  href: '/dashboard/barangay-monitoring/geography', icon: 'hugeicons:shield-user',   accessLevels: [1,2,4,3] },
            { label: 'Barangay Population Dashboard',  href: '/dashboard/barangay-monitoring/population', icon: 'hugeicons:shield-user',   accessLevels: [1,4,2,3] },
            { label: 'Report PK Activities Monitoring',  href: '/dashboard/barangay-monitoring/pk-activities', icon: 'hugeicons:shield-user',   accessLevels: [1,4,2,3] },
